-- Migración: Corregir duplicados en función get_team_roster_admin
-- Fecha: Enero 2025
-- Descripción: Corrige la lógica para evitar duplicados en los resultados

-- Recrear la función con lógica corregida para evitar duplicados
...
BEGIN
    ...
    LEFT JOIN player_stats ps ON tr.player_id = ps.player_id AND ps.week = week_num
